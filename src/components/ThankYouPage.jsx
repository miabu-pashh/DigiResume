  ...
  return (
    <div className="thankyou-container">
      ...
      <p className="thankyou-message">
        I sincerely appreciate you taking the time to explore my digital resume.
        This journey has been a reflection of my growth, experiences, and the
        passion I bring to every project I undertake. Whether it’s engineering
        software, solving real-world problems, or building something from
        scratch, I believe in delivering meaningful impact with precision and
        creativity.
      </p>

      <p className="thankyou-message">
        If you’d like to connect, collaborate, or simply learn more about my
        work, feel free to reach out. I’m always open to exciting opportunities
