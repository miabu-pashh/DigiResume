      ...
      <div className="achievements-wrapper">
        ...
        <section className="achievement-section">
          ...
          <p className="achievement-description">
            Founded and led a hardware startup specializing in industrial
            pipeline valve manufacturing. Took charge of both product design and
            market strategy. Successfully created detailed product catalogs and
            executed offline marketing campaigns that boosted our local
            presence. The experience gave deep insights into entrepreneurship,
            client communication, and brand building in a competitive industry.
          </p>
          ...
          <div className="achievement-header">
            ...
            <div>
              <h3 className="achievement-role">
                Design & Transmission Co-Lead
              </h3>
              <p className="achievement-company">
          ...
          <p className="achievement-description">
            Co-led the design and transmission unit for a custom-built All
            Terrain Vehicle (ATV) in the prestigious SAE BAJA competition.
            Spearheaded the development of drivetrain systems including gearbox,
            axles, CVT, and engine mounting. From CAD design to final assembly,
            played a hands-on role in shaping a high-performance buggy.
          </p>

          <p className="achievement-description">
            Our team participated in events across India and emerged victorious
            at the national level — securing{" "}
            ...
            bagged <strong>Champions Trophy</strong> at Mega ATV 2021 in
            endurance and dirt races. This project taught resilience,
            collaboration, and how raw engineering meets innovation.
          </p>
        </section>
